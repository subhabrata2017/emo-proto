...
const routes = [
    ...
    {
        path: 'child-tree',
        loadChildren: () => Promise.all(/*! import() | child-tree-child-tree-module */[__webpack_require__.e("common"), __webpack_require__.e("child-tree-child-tree-module")]).then(__webpack_require__.bind(null, /*! ./child-tree/child-tree.module */ "./src/app/child-tree/child-tree.module.ts")).then(m => m.ChildTreePageModule)
    },
    {
        path: 'add-user',
        loadChildren: () => Promise.all(/*! import() | add-user-add-user-module */[__webpack_require__.e("common"), __webpack_require__.e("add-user-add-user-module")]).then(__webpack_require__.bind(null, /*! ./add-user/add-user.module */ "./src/app/add-user/add-user.module.ts")).then(m => m.AddUserPageModule)
    },
];
...
module.exports = __webpack_require__(/*! /Users/Subhabrata/dev/ionic demo/emoinu-proto/src/main.ts */"./src/main.ts");
