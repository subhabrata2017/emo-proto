      ...
      var UserService = /*#__PURE__*/function () {
        ...
        _createClass(UserService, [{
          ...
          value: function getUser(userId) {
            return Object.assign({}, this.users.find(function (user) {
              return user.id == userId;
            }));
          }
        }, {
          key: "getChildUsers",
          value: function getChildUsers(parentId) {
            var childList = [];
            var storedUsers = JSON.parse(localStorage.getItem("emoinu-data"));

            var _iterator = _createForOfIteratorHelper(storedUsers),
                _step;

            try {
              for (_iterator.s(); !(_step = _iterator.n()).done;) {
                var eachUser = _step.value;
          ...
          key: "getChildUserCount",
          value: function getChildUserCount(parentId) {
            var storedUsers = JSON.parse(localStorage.getItem("emoinu-data"));
            var count = 0;

            var _iterator2 = _createForOfIteratorHelper(storedUsers),
                _step2;

            try {
              for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
                var eachUser = _step2.value;
